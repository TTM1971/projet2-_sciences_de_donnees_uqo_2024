...
Ce projet consistait a faire une analyse sur des eleves afin de determier les facteur qui influencel'apprentissage des etudiants a l'aide d'un modele de regresson 